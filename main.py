...
class Software(MDApp):
    ...
    def User(self):
        self.mainpage.ids.layout.remove_widget(self.mainpage.ids.user)
        self.mainpage.ids.layout.remove_widget(self.mainpage.ids.history)

    def Admin(self):
        try:
            self.mainpage.ids.layout.add_widget(self.mainpage.ids.user)
            self.mainpage.ids.layout.add_widget(self.mainpage.ids.history)
        except:
            pass
